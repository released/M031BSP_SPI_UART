...
void Emulate_EEPROM_Process(void)
{
	...
	uint8_t cnt = 0;
	uint8_t i = 0;
	uint8_t string[] = "Emulate_EEPROM_Process finish !" ; 
...
void SPI_Master_Loop_Process(void)
{
	...
	if (is_flag_set(flag_SPI_TX_Finish))	
	{
	...
	if (is_flag_set(flag_SPI_RX_Finish))	
	{
	    ...
	    for(u32DataCount = 0; u32DataCount < MASTER_DATA_NUM; u32DataCount++)
	    {
...
void SPI_Master_Slave_HW_Init(void)
{
...
//    CLK_WaitClockReady(CLK_STATUS_HXTSTB_Msk);
	...
	//SPI0 : PA0 : SPI0_MOSI , PA1 : SPI0_MISO , PA2 : SPI0_CLK , PA3 : SPI0_SS
	SPI_Master_Slave_HW_Init();
